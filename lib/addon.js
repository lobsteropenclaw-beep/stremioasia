...
builder.defineCatalogHandler(async ({ type, id, extra }) => {
  ...
  if (id === 'asian_drama_kr') countries = ['KR'];
  else if (id === 'asian_drama_cn') countries = ['CN', 'HK', 'TW'];
  else if (id === 'asian_drama_jp') countries = ['JP'];
  else if (id === 'asian_movies_all') countries = ['KR', 'CN', 'JP', 'HK', 'TW'];

  const data = await tmdb.discover(type, countries, page);
