...
const manifest = {
  id: 'community.stremio.asian-discovery-v6',
  version: '6.0.0',
  name: 'Asian Discovery PRO+',
  description: 'Premium Korean, Chinese, Japanese, and Thai catalogs. Organized by country with genre filters.',
  ...
  catalogs: [
    ...
    // MOVIES
    {
      ...
      extra: [
        ...
        { 
          name: 'genre', 
          options: ['Action', 'Comedy', 'Romance', 'Horror', 'Thriller', 'Drama', 'Animation', 'Crime', 'Fantasy'],
          isRequired: false
        }
      ]
    },
